...
# Additional completion definitons for ZSH
zplug "zsh-users/zsh-completions"

zplug "zsh-users/zsh-autosuggestions"
# I believe unnecessary given functionality of zsh-users/zsh-autosuggestions
...
# Interesting, to install with time
#https://github.com/joepvd/zsh-hints

####################
#  60o_NPM
####################
#  npm zsh completon shell script
# https://github.com/kuno/npm-zsh-completion
